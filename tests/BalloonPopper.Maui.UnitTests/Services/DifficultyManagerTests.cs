...
namespace BalloonPopper.Maui.UnitTests.Services
{
    ...
    public class DifficultyManagerTests
    {
        ...
        public void GetTimeScaleForLevel_ShouldIncreaseWithLevel_ButBeCapped()
        {
            ...
            timeScale20.Should().BeLessOrEqualTo(1.5); // Capped at 50% increase
        }
        ...
        public void GetBalloonSpeedMultiplier_ShouldIncreaseWithLevel_ButBeCapped()
        {
            ...
            multiplier20.Should().BeLessOrEqualTo(2.0); // Capped at 200%
        }
        ...
        public void GetSpawnRateMultiplier_ShouldIncreaseWithLevel_ButBeCapped()
        {
            ...
            // Assert
            multiplier5.Should().BeGreaterThan(multiplier1);
            multiplier50.Should().BeLessOrEqualTo(3.0); // Capped at 300%
        }
    }
    ...
    public class ScoringServiceTests
    {
        ...
        {
            // Act
            var level1Bonus = _scoringService.CalculateLevelCompletionBonus(1, 3, TimeSpan.FromMinutes(1));
            var level5Bonus = _scoringService.CalculateLevelCompletionBonus(5, 3, TimeSpan.FromMinutes(1));
        ...
        {
            // Act
            var bonus1Life = _scoringService.CalculateLevelCompletionBonus(1, 1, TimeSpan.FromMinutes(1));
            var bonus3Lives = _scoringService.CalculateLevelCompletionBonus(1, 3, TimeSpan.FromMinutes(1));
